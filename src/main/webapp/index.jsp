...
<head>
	...
	<title>Cardio: Fitnes club</title>
				...
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
                                           	    ...
                                           	    <h1 class="light-white">AXA GYM</h1>
                                                    <h3 class="light white">Take care of your body.</h3>
                                                    <h1 class="light-white">It's the only place you have to live.</h1>
					...
					<div class="intro-table intro-table-third">
						...
						<div class="owl-testimonials bottom">
							<div class="item">
								...
								<h5 class="white heading light author">Anand Kumar</h5>
							</div>
							<div class="item">
								<h4 class="white heading content">I can't believe how much better I feel!</h4>
								<h5 class="white heading light author">Shikha Sharma</h5>
							</div>
							<div class="item">
								<h4 class="white heading content">Incredible transformation and I feel so healthy!</h4>
								<h5 class="white heading light author">Pranay Lambat</h5>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-7 no-padding col-md-offset-5 pricings text-center">
					<div class="pricing">
					  <center>
							...
							<h4 class="white regular light">Rs.15000 <span class="small-font">/ year</span></h4>
					...
					<div class="pricing">
						<!--<div class="box-main" data-img="img/pricing2.jpg">-->
							...
							<h4 class="white regular light">Rs.1000 <span class="small-font">/ year</span></h4>
							<!--<a href="#" data-toggle="modal" data-target="#modal1" class="btn btn-white-fill">Sign Up Now</a>-->
							<!--<i class="info-icon icon_question"></i>-->
                                                </center>
						</div>
	...
	<footer>
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 text-center-mobile">
					<h3 class="white">Opening Hours 
                                            <!--<span class="open-blink"></span>-->
                                        </h3>
					<div class="row opening-hours">
						<div class="col-sm-8 text-center-mobile">
							<h5 class="light-white light">Mon - Fri</h5>
							<h3 class="regular white">9:00 AM- 10:00 PM</h3>
						</div>
						<div class="col-sm-8 text-center-mobile">
							<h5 class="light-white light">Sat - Sun</h5>
							<h3 class="regular white">10:00 AM - 06:00 PM</h3>
						</div>
					</div>
				</div>
			</div>
